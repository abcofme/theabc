...
ЕСЛИ ситуация или реакция содержит бред, спам, бессмысленный набор букв, что-то абсолютно нереалистичное, неадекватное или странное, то верни в поле explanation строго строку ",,," (без кавычек), а score сделай 50.
