...
# Эндпоинт 5: Генерация портрета личности
...
Интроверсия / Экстраверсия ([X]% / [Y]%)
Стрессоустойчивость / Ранимость ([X]% / [Y]%)
Новаторство / Консерватизм ([X]% / [Y]%)
Сотрудничество / Соперничество ([X]% / [Y]%)
Системность / Гибкость ([X]% / [Y]%)
...
Карта ценностей
(От 3 до 7 ценностей с описанием)
