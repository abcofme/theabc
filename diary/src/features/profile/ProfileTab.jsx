...
* **Блок «Профориентация»** — предоставляется на основе разового платежа. Стоимость составляет 1499 (одна тысяча четыреста девяносто девять) рублей (доступ предоставляется навсегда).
...
3.4. Пользователь вправе в любой момент отменить автоматическое продление подписки с помощью кнопки «Отменить подписку», расположенной в самом низу раздела «Профиль» внутри Сервиса. При отмене подписки доступ сохраняется до конца оплаченного периода.
...
4.1. Услуга считается оказанной в полном объеме и надлежащего качества в момент предоставления Пользователю доступа к платному функционалу (цифровому контенту) Сервиса.
4.2. **Политика возврата:** В соответствии с законодательством РФ, возврат денежных средств за предоставленное право использования цифрового контента и программного обеспечения не производится. Совершая оплату, Пользователь соглашается с тем, что после получения доступа к подписке «Premium» или блоку «Профориентация» возврат уплаченных средств невозможен, в том числе при досрочном отказе от использования Сервиса.
4.3. Возврат возможен исключительно в случаях технических сбоев на стороне Исполнителя, если оплаченная Услуга не была предоставлена фактически (доступ не был открыт).
